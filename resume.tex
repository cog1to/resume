...
\cvlist{
  \item Participating in the architecture design \& development of Messenger module of Avito iOS app [\href{https://apps.apple.com/ru/app/\%D0\%B0\%D0\%B2\%D0\%B8\%D1\%82\%D0\%BE-\%D0\%BE\%D0\%B1\%D1\%8A\%D1\%8F\%D0\%B2\%D0\%BB\%D0\%B5\%D0\%BD\%D0\%B8\%D1\%8F/id417281773}{link}].
  \item Working on various parts of back-end infrastructure within Messenger's cluster of microservices.
}
\vspace{1ex}
